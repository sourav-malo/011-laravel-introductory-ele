        ...
        <div class="col-12">
          <div class="about__info__wrap">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              >
                {!! $aboutUsDetails->long_description !!}
              </div>
              <div
                class="tab-pane fade"
                id="skills"
        ...
        <div class="row gx-0">
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="services__style__two__item">
              ...
              <div class="services__style__two__content">
                <h3 class="title">
                  <a href="services-details.html">Business Strategy</a>
                </h3>
                <p>
                  There are many variations of passages of Lorem Ipsum
                  available, but the majority.
                </p>
                <a href="services-details.html" class="services__btn"
            ...
            <div class="services__style__two__item">
              ...
              <div class="services__style__two__content">
                ...
                <p>
                  ...
                  behavior.Strategy is a forward-looking plan.
                </p>
                <a href="services-details.html" class="services__btn"
                  ><i class="far fa-long-arrow-right"></i
                ></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="services__style__two__item">
              ...
              <div class="services__style__two__content">
                <h3 class="title">
                  <a href="services-details.html">Animation</a>
                </h3>
                <p>
                  Strategy is a forward-looking plan for your brand’s
                  behavior.Strategy is a forward-looking plan.
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="services__style__two__item">
              ...
              <div class="services__style__two__content">
                <h3 class="title">
                  <a href="services-details.html">Brand strategy</a>
                </h3>
                <p>
                  Strategy is a forward-looking plan for your brand’s
                  behavior.Strategy is a forward-looking plan.
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 col-lg-11">
          <div class="testimonial__wrap">
            ...
            <div
              class="testimonial__two__active slick-initialized slick-slider"
            >
              <div class="slick-list draggable">
                <div class="slick-track" style="opacity: 1; width: 1920px">
                  <div
                    class="testimonial__item slick-slide slick-current slick-active"
                    data-slick-index="0"
                    aria-hidden="false"
                    style="
                      width: 960px;
                  ...
                  >
                    ...
                    <div class="testimonial__content">
                      <p>
                        ...
                        your trust in us &amp;share in our H.Spond Asset
                      ...
                      <div class="testimonial__avatar">
                        ...
                        <div class="testi__avatar__img">
                          <img
                            src="{{ asset('frontend/assets/img/images/testi_avatar01.png') }}"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  <div
                    class="testimonial__item slick-slide"
                    data-slick-index="1"
                    aria-hidden="true"
                    style="
                      width: 960px;
                  ...
                  >
                    ...
                    <div class="testimonial__content">
                      ...
                      <div class="testimonial__avatar">
                        ...
                        <div class="testi__avatar__img">
                          <img
                            src="{{ asset('frontend/assets/img/images/testi_avatar02.png') }}"
                            alt=""
                          />
                        </div>
                      </div>
      ...
      <div class="row gx-0 justify-content-center">
          ...
          <div class="blog__post__item">
            <div class="blog__post__thumb">
              <a href="blog-details.html"
                ><img src="{{ asset('frontend/assets/img/blog/blog_post_thumb01.jpg') }}" alt=""
              /></a>
            ...
            <div class="blog__post__content">
              ...
              <h3 class="title">
                <a href="blog-details.html"
                  >Facebook design is dedicated to what's new in design</a
                >
              </h3>
        ...
        <div class="col-lg-4 col-md-6 col-sm-9">
          <div class="blog__post__item">
            <div class="blog__post__thumb">
              <a href="blog-details.html"
                ><img src="{{ asset('frontend/assets/img/blog/blog_post_thumb02.jpg') }}" alt=""
              /></a>
              <div class="blog__post__tags">
            ...
            <div class="blog__post__content">
              ...
              <h3 class="title">
                <a href="blog-details.html"
                  >Make communication Fast and Effectively.</a
                >
              </h3>
              <a href="blog-details.html" class="read__more">Read mORe</a>
            </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-9">
          <div class="blog__post__item">
            <div class="blog__post__thumb">
              <a href="blog-details.html"
                ><img src="{{ asset('frontend/assets/img/blog/blog_post_thumb03.jpg') }}" alt=""
              /></a>
              <div class="blog__post__tags">
            ...
            <div class="blog__post__content">
              ...
              <h3 class="title">
                <a href="blog-details.html"
                  >How to increase your productivity at work - 2021</a
                >
              </h3>
              <a href="blog-details.html" class="read__more">Read mORe</a>
            </div>
