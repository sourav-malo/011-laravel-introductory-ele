          ...
          <div class="standard__blog__post">
            ...
            <div class="blog__details__content services__details__content">
              <ul class="blog__post__meta">
                ...
                <li class="post-share">
                  <a href="#"><i class="fal fa-share-all"></i> (18)</a>
                </li>
              </ul>
              <h2 class="title">
                {{ $post->title }}
                    ...
                    <div class="blog__next__prev__post">
                      <div class="blog__next__prev__thumb">
                        <a href="blog-details.html"
                          ><img src="{{ asset('frontend/assets/img/blog/blog_prev.jpg') }}" alt=""
                        /></a>
                      </div>
                ...
                <div class="col-xl-5 col-md-6">
                  <div class="blog__next__prev__item next_post text-end">
                    ...
                    <div class="blog__next__prev__post">
                      <div class="blog__next__prev__thumb">
                        <a href="blog-details.html"
                          ><img src="{{ asset('frontend/assets/img/blog/blog_next.jpg') }}" alt=""
                        /></a>
                      </div>
                      <div class="blog__next__prev__content">
                        <h5 class="title">
                ...
                @foreach($latestPosts as $post)
                  <li class="rc__post__item">
                    ...
                    <div class="rc__post__content">
                      <h5 class="title">
                        <a href="{{ route('blog_posts.show', $post->id) }}">{{ $post->title }}</a>
                      </h5>
