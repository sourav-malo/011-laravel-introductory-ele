                  ...
                  @foreach($posts as $post)
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img src="{{ $post->image ? asset($post->image) : asset('uploads/no_image.jpg') }}" alt=""></a>
                            <a href="{{ route('blog_posts.show', $post->id) }}" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                        <div class="standard__blog__content">
                            ...
                            <h2 class="title"><a href="blog-details.html">{{ $post->title }}</a></h2>
